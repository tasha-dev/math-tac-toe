    ...
    useEffect(() => {
        ...
        function checkWin(choices:number[]):boolean {
            ...
            const winningPatterns = [
                ...
                [7,8,9,10], [8,9,10,12], [9,10,12,14],
                [15,16,18,20], [16,18,20,21], [18,20,21,24],
                [25,27,28,30], [27,28,30,32], [28,30,32,35],
                [36,40,42,45], [40,42,45,48], [42,45,48,49],
                [54,56,63,64], [56,63,64,72], [63,64,72,81],
                [1,7,15,25], [7,15,25,36], [15,25,36,54],
                [2,8,16,27], [8,16,27,40], [16,27,40,56],
                [3,9,18,28], [9,18,28,42], [18,28,42,63],
                [4,10,20,30], [10,20,30,45], [20,30,45,64],
                [5,12,21,32], [12,21,32,48], [21,32,48,72],
                [6,14,24,35], [14,24,35,49], [24,35,49,81],
                [1,8,18,30], [2,9,20,32], [3,10,21,35],
                [7,16,28,45], [8,18,30,48], [9,20,32,49],
                [15,27,42,64], [16,28,45,72], [18,30,48,81],
                [4,9,16,25], [5,10,18,27], [6,12,20,28],
                [10,18,27,36], [12,20,28,40], [14,21,30,42],
                [20,28,40,54], [21,30,42,56], [24,32,45,63]
            ];
